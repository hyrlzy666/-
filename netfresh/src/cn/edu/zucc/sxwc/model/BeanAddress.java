...
public class BeanAddress {//配送地址表
	public static final String[] AddressTitles={"地址编号","省","市","地址","联系人","电话"};
	...
	public String getCell(int col){
		...
		else if(col==3) return String.valueOf(address);
		else if(col==4) return String.valueOf(contact);
		else if(col==5) return String.valueOf(phonenum);
		else return "";
	}
